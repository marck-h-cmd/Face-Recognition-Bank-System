...
class FaceRecognitionApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Face Recognition Scanner")
        ...
        self.register_button = tk.Button(root, text="Register Face", command=self.capture_face)
        self.register_button.pack(side=tk.LEFT, padx=10, pady=10)

        self.verify_button = tk.Button(root, text="Verify Face", command=self.verify_face)
    ...
    def update_frame(self):
        ...
        if ret:
            ...
            self.root.photo = photo  # Keep a reference to avoid garbage collection
    ...
    def capture_face(self):
        ...
        if faces:
            ...
            self.canvas.create_image(0, 0, anchor=tk.NW, image=photo)
            self.root.photo = photo  # Keep reference
